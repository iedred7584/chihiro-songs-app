  ...
  <v-container>
    <v-card rounded @click="onClick">
      ...
      <div class="d-flex flex-no-wrap justify-space-between">
        <div>
          <v-card-title v-text="card.title" class="card-info card-title"></v-card-title>

          <v-card-subtitle v-if="card.subtitle" v-text="card.subtitle" class="card-info card-subtitle"></v-card-subtitle>
        </div>
      </div>
    </v-card>
  </v-container>
