...
export class Video {
  constructor(readonly id: string, readonly publishedAt: string, protected url: string | null = null, protected title: string | null = null, protected channel: Channel | null = null, protected isVideoInfoFetched = false, useCache = true) {
  ...
  public clone(useCache = true): Video {
    return new Video(this.id, this.publishedAt, this.url, this.title, this.channel !== null ? this.channel.clone() : null, this.isVideoInfoFetched, useCache)
  }
