<template>
  <v-app>
    <v-app-bar app color="main" height="50" elevation="0" class="header">
      <div class="d-flex align-center"></div>

      <v-spacer></v-spacer>

      <v-dialog max-width="820px">
    ...
    <v-main>
      <v-container class="d-flex main-container">
        ...
        <div class="right">
          <div id="search">
            <v-icon color="accent" size="30" class="icon-search">mdi-magnify</v-icon>
            <v-text-field v-model="query" color="accent" hint="キーワードで検索: 「歌ってみた コラボ」「歌枠 音源あり」..."></v-text-field>
            <v-btn icon class="btn-clear-query" @click="query = ''">
